...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar país al que pertenece un atleta\n");
	}
	...
	/**
	 * Este método sirve para imprimir un mensaje en la consola notificándole
	 * al usuario el país al que el atleta pasado por parámetro pertenece.
	 */
	public void ejecutarPaisDeAtleta() {
		System.out.println("\nConsultar país al que pertenece un atleta");
		String nombreAtleta = input("Ingrese el nombre del atleta");
		String paisDelAtleta = calculadora.buscarPaisAtleta(nombreAtleta);
		if (paisDelAtleta != null) {
			System.out.println("El atleta '" + nombreAtleta + "' es oriundo de '" + paisDelAtleta + "'.");
		}
		else
			System.out.println("No existe un atleta registrado con el nombre '" + nombreAtleta + "'.");
	}
