...
public class CalculadoraEstadisticas
{
	 ...
	 * 
	 * @param nombreAtleta Nombre del atleta.
	 * @return Nombre del país del atleta.
	 */
	public String buscarPaisAtleta(String nombreAtelta) {
		String nombrePais = null;
		Atleta elAtleta = buscarAtleta(nombreAtelta);
		if (elAtleta != null)
			nombrePais = elAtleta.darPais().darNombre();
		return nombrePais;
	}
